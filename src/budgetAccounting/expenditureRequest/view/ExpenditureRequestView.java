...
//	}
	...
	public void menu() {
		...
		System.out.println("2️⃣ 지출 신청 전체 조회");
		System.out.println("3️⃣ 특정 지출 신청 조회");
		System.out.println("4️⃣ 지출 신청 승인 및 지출 등록");
		System.out.println("5️⃣ 지출 신청 수정");
		System.out.println("6️⃣ 지출 신청 삭제");
		System.out.println();
		System.out.print("⏩ ");
	}
}
